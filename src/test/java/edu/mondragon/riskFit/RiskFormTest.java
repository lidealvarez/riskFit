...
public class RiskFormTest {
    ...
    public void testGetSetTrainingHoursPerWeek() {
        ...
        assertEquals(expectedTrainingHours, riskForm.getTrainingHoursPerWeek(),
                "Las horas de entrenamiento por semana no se establecen correctamente");
    }
    ...
    public void testGetSetTrainingIntensity() {
        ...
        assertEquals(expectedIntensity, riskForm.getTrainingIntensity(),
                "La intensidad de entrenamiento no se establece correctamente");
    }
    ...
    public void testGetSetWeeklyTrainingVolume() {
        ...
        assertEquals(expectedVolume, riskForm.getWeeklyTrainingVolume(),
                "El volumen de entrenamiento semanal no se establece correctamente");
    }
    ...
    public void testGetSetLoadProgression() {
        ...
        assertEquals(expectedLoadProgression, riskForm.getLoadProgression(),
                "La progresión de carga no se establece correctamente");
    }
}
